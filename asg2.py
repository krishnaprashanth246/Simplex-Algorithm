...
# Sample Output:
# 	The maximum for the given Linear Program is at: [0. 5.]
# 	The corresponding objective function value is: 10.0
...
if __name__ == '__main__':
	print("Simplex Algorithm with non-degenerate and rank of matrix equal number of columns")
	m = int(input("Enter m = "))
	n = int(input("Enter n = "))
